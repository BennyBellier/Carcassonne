...
public class IA
{
    ...
    */
    public String meepleEasy (GameSet g, int i, int j)
    {
        Tile [][] board = g.cloneSet();
    ...
    public int [] playEasy(GameSet g, Tile t)
    {
        currentConfig = g.cloneSet();
        ...
        validPositions =  encodeCoords(g.tilePositionsAllowed(currentTile, true));
        ...
        Configuration.instance().logger().info("Tuile " + t + " placée aux coordonnées (" + posx + "," + posy + ") tournée de " + randomRotation + " degrés à droite.\n");
